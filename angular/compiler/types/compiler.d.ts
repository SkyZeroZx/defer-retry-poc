...
declare class RegularExpressionLiteralExpr extends Expression {
    ...
    isConstant(): boolean;
    visitExpression(visitor: ExpressionVisitor, context: any): any;
    clone(): RegularExpressionLiteralExpr;
}
...
type output_ast_d_RegularExpressionLiteralExpr = RegularExpressionLiteralExpr;
declare const output_ast_d_RegularExpressionLiteralExpr: typeof RegularExpressionLiteralExpr;
...
declare class ArrowFunctionIdentifierParameter {
    name: string;
    span: ParseSpan;
    sourceSpan: AbsoluteSourceSpan;
    constructor(name: string, span: ParseSpan, sourceSpan: AbsoluteSourceSpan);
}
type ArrowFunctionParameter = ArrowFunctionIdentifierParameter;
declare class ArrowFunction extends AST {
    parameters: ArrowFunctionParameter[];
    body: AST;
    constructor(span: ParseSpan, sourceSpan: AbsoluteSourceSpan, parameters: ArrowFunctionParameter[], body: AST);
    visit(visitor: AstVisitor, context?: any): any;
}
...
interface CompilerFacade {
    ...
    compileService(angularCoreEnv: CoreEnvironment, sourceMapUrl: string, meta: R3ServiceMetadataFacade): any;
    compileServiceDeclaration(angularCoreEnv: CoreEnvironment, sourceMapUrl: string, meta: R3DeclareServiceFacade): any;
...
interface R3ServiceMetadataFacade {
    name: string;
    type: Type;
    typeArgumentCount: number;
...
declare function isUnsafeObjectKey(key: string): boolean;
/**
...
declare function createInjectableType(type: Expression, typeArgumentCount: number): ExpressionType;
declare function delegateToFactory(type: WrappedNodeExpr<any>, useType: WrappedNodeExpr<any>, unwrapForwardRefs: boolean): Expression;
...
declare function compileService(meta: R3ServiceMetadata, resolveForwardRefs: boolean): R3CompiledExpression;
...
declare class CompilerFacadeImpl implements CompilerFacade {
    ...
    compileDirectiveDeclaration(angularCoreEnv: CoreEnvironment, sourceMapUrl: string, declaration: R3DeclareDirectiveFacade): any;
    compileService(angularCoreEnv: CoreEnvironment, sourceMapUrl: string, facade: R3ServiceMetadataFacade): any;
    compileServiceDeclaration(angularCoreEnv: CoreEnvironment, sourceMapUrl: string, facade: R3DeclareServiceFacade): any;
 ...
 */
declare class ClassPropertyMapping<T extends InputOrOutput = InputOrOutput> {
    /**
...
declare class DeferredBlockError extends BlockNode implements Node {
    ...
    i18n?: I18nMeta$1 | undefined;
    constructor(children: Node[], retryCount: number | null, nameSpan: ParseSourceSpan$1, sourceSpan: ParseSourceSpan$1, startSourceSpan: ParseSourceSpan$1, endSourceSpan: ParseSourceSpan$1 | null, i18n?: I18nMeta$1 | undefined);
    visit<Result>(visitor: Visitor<Result>): Result;
}
...
interface ConflictingHostDirectiveBinding<DirectiveT> {
...
interface BoundTarget<DirectiveT extends DirectiveMeta> {
     ...
     */
    getConflictingHostDirectiveBindings(node: DirectiveOwner): ConflictingHostDirectiveBinding<DirectiveT>[] | null;
}
 ...
 * enforced during linking.
 */
interface R3DeclareServiceMetadata extends R3PartialDeclaration {
    /**
 ...
 */
declare function compileDeclareServiceFromMetadata(meta: R3ServiceMetadata): R3CompiledExpression;
...
declare class Identifiers {
    ...
    static deferEnableRetry: ExternalReference;
    ...
    static defineService: ExternalReference;
    static declareService: ExternalReference;
