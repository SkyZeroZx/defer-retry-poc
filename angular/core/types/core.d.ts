...
declare function maybeUnwrapDefaultExport<T>(input: T | DefaultExport<T>): T;
 ...
 * @publicApi 22.0
 */
type PrefetchTrigger = () => Promise<void>;
/**
 ...
 * @publicApi 22.0
 */
declare function onIdle(options?: {
    timeout?: number;
}): Promise<void>;
...
interface ServiceDecorator {
    ...
    <T>(options: {
        autoProvided?: true;
        factory: () => T;
    }): <C extends Type$1<unknown> | AbstractType<unknown>>(target: C) => C extends Type$1<unknown> ? Type$1<T> : abstract new (...args: any[]) => T;
    /**
 ...
 * @codeGenApi
 */
declare function ɵɵdeferEnableRetry(tDetails: TDeferBlockDetails, retryCount: number): void;
 ...
 */
declare const CACHE_ACTIVE: InjectionToken<{
    isActive: boolean;
}>;
 ...
 * @codeGenApi
 */
declare function ɵɵdefer(index: number, primaryTmplIndex: number, dependencyResolverFn?: DependencyResolverFn | null, loadingTmplIndex?: number | null, placeholderTmplIndex?: number | null, errorTmplIndex?: number | null, loadingConfigIndex?: number | null, placeholderConfigIndex?: number | null, enableTimerScheduling?: typeof ɵɵdeferEnableTimerScheduling | null, flags?: TDeferDetailsFlags | null, enableRetry?: typeof ɵɵdeferEnableRetry | null, retryCount?: number | null): void;
/**
 ...
 * @codeGenApi
 */
declare function ɵɵcontrol(): void;
 ...
 * @codeGenApi
 */
declare function ɵɵarrowFunction<T>(slotOffset: number, factory: (context: T, view: LView) => (...args: unknown[]) => unknown, context: T): any;
 ...
 * @codeGenApi
 */
declare function ɵɵenableIncrementalHydrationRuntime(): void;
...
declare function ɵɵngDeclareClassMetadataAsync(decl: {
    type: Type$1<any>;
    resolveDeferredDeps: () => Array<() => Promise<Type$1<unknown>>>;
 ...
 * @publicApi
 */
interface DeferBlockRetryContext<T = unknown> {
    /**
 ...
 * @publicApi
 */
type DeferBlockRetryHandler = <T>(load: () => Promise<T>, context: DeferBlockRetryContext<T>) => Promise<T>;
/**
 ...
 */
declare function provideDeferBlockRetryHandler(handler: DeferBlockRetryHandler): EnvironmentProviders;
